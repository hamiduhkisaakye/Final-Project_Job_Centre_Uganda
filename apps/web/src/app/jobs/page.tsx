    ...
    <>
      ...
      <div className="sticky top-[72px] z-20 bg-ground border-b border-border">
        <div className="max-w-[1320px] mx-auto px-6 py-4">
          <form action="/jobs" className="bg-white rounded border border-border flex flex-col sm:flex-row items-stretch sm:items-center max-w-[820px] sm:h-11 overflow-hidden">
      ...
      <JobsResults jobs={jobs} total={total} query={flat.q} location={flat.location} facets={result?.meta?.facets?.categories} />
